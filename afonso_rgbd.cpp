...
//   std::string init_file = "";
  ...
  std::string config_color = "model/wood-block/wood-block.xml", config_depth = "model/wood-block/wood-block_depth.xml";
  std::string model_color = "model/wood-block/wood-block.cao", model_depth = "model/wood-block/wood-block.cao";
  std::string init_file = "model/wood-block/wood-block.init";
